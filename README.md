...
The [RECSEN compiler](#compiler) (rsc command) parses RECSEN files, processes protocol and produces either an XML protocol definition for further arbitrary processing or client-server protocol handlers ready for use in an application. 
